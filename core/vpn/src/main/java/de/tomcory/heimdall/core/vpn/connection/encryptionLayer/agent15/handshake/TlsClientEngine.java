...
public class TlsClientEngine extends TlsEngine implements ClientMessageProcessor {
    ...
    private de.tomcory.heimdall.core.vpn.connection.encryptionLayer.agent15.handshake.ClientHello clientHello;
    ...
    public void startHandshake(TlsConstants.NamedGroup ecCurve, List<TlsConstants.SignatureScheme> signatureSchemes) throws IOException {
        ...
        clientHello = new de.tomcory.heimdall.core.vpn.connection.encryptionLayer.agent15.handshake.ClientHello(serverName, publicKey, compatibilityMode, supportedCiphers, supportedSignatures,
