...
import de.tomcory.heimdall.core.vpn.connection.encryptionLayer.agent15.compat.InputStreamCompat;
import de.tomcory.heimdall.core.vpn.connection.encryptionLayer.agent15.handshake.TlsServerEngine;
...
//        this.certificateKey = readPrivateKey(certificateKeyFile);
    ...
    public de.tomcory.heimdall.core.vpn.connection.encryptionLayer.agent15.handshake.TlsServerEngine createServerEngine(ServerMessageSender serverMessageSender, TlsStatusEventHandler tlsStatusHandler) {
        de.tomcory.heimdall.core.vpn.connection.encryptionLayer.agent15.handshake.TlsServerEngine tlsServerEngine = new TlsServerEngine(serverCertificates, certificateKey, serverMessageSender, tlsStatusHandler, tlsSessionRegistry);
