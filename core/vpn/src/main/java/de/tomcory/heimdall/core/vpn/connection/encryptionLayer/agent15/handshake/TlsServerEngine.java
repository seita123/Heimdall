...
import static de.tomcory.heimdall.core.vpn.connection.encryptionLayer.agent15.TlsConstants.CipherSuite.TLS_AES_128_GCM_SHA256;
import static de.tomcory.heimdall.core.vpn.connection.encryptionLayer.agent15.TlsConstants.NamedGroup.*;
import static de.tomcory.heimdall.core.vpn.connection.encryptionLayer.agent15.TlsConstants.PskKeyExchangeMode.psk_dhe_ke;
import static de.tomcory.heimdall.core.vpn.connection.encryptionLayer.agent15.TlsConstants.SignatureScheme.rsa_pss_rsae_sha256;
...
import de.tomcory.heimdall.core.vpn.connection.encryptionLayer.agent15.alert.*;
import de.tomcory.heimdall.core.vpn.connection.encryptionLayer.agent15.extension.*;
