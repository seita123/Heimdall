 ...
 */
package de.tomcory.heimdall.core.vpn.connection.encryptionLayer.agent15.extension;

import static de.tomcory.heimdall.core.vpn.connection.encryptionLayer.agent15.TlsConstants.NamedGroup.secp256r1;
import static de.tomcory.heimdall.core.vpn.connection.encryptionLayer.agent15.TlsConstants.NamedGroup.x25519;
import static de.tomcory.heimdall.core.vpn.connection.encryptionLayer.agent15.TlsConstants.NamedGroup.x448;
...
//    public static final List<TlsConstants.NamedGroup> supportedCurves = List.of(secp256r1, x25519);
    public static final List<TlsConstants.NamedGroup> supportedCurves = List.of(secp256r1);
