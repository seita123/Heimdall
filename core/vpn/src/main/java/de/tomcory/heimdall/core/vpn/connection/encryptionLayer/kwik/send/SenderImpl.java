 ...
 */
package de.tomcory.heimdall.core.vpn.connection.encryptionLayer.kwik.send;
...
import de.tomcory.heimdall.core.vpn.connection.encryptionLayer.kwik.cc.CongestionControlEventListener;
import de.tomcory.heimdall.core.vpn.connection.encryptionLayer.kwik.cc.CongestionController;
import de.tomcory.heimdall.core.vpn.connection.encryptionLayer.kwik.cc.NewRenoCongestionController;
...
import de.tomcory.heimdall.core.vpn.connection.encryptionLayer.kwik.packet.RetryPacket;
import de.tomcory.heimdall.core.vpn.connection.encryptionLayer.kwik.packet.ShortHeaderPacket;
import de.tomcory.heimdall.core.vpn.connection.encryptionLayer.kwik.qlog.QLog;
import de.tomcory.heimdall.core.vpn.connection.encryptionLayer.kwik.recovery.RecoveryManager;
import de.tomcory.heimdall.core.vpn.connection.encryptionLayer.kwik.recovery.RttEstimator;
...
public class SenderImpl implements Sender, CongestionControlEventListener {
    ...
    void send(List<SendItem> itemsToSend) throws IOException {
        ...
        byte[] datagramDataRealSize = Arrays.copyOfRange(datagramData, 0, buffer.position());
