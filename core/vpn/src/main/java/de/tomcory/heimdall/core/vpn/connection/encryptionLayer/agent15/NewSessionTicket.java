...
import de.tomcory.heimdall.core.vpn.connection.encryptionLayer.agent15.handshake.NewSessionTicketMessage;
...
public class NewSessionTicket {
    ...
    protected NewSessionTicket(byte[] data) {
        ...
        if (buffer.remaining() > 0) {
            ...
            cipher = Stream.of(TlsConstants.CipherSuite.values()).filter(c -> c.value == cipherEncoding).findAny().orElseThrow(NoSuchElementException::new);
        }
        else {
