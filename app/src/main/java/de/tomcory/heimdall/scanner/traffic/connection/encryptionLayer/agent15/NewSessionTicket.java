...
public class NewSessionTicket {
    ...
    protected de.tomcory.heimdall.scanner.traffic.connection.encryptionLayer.agent15.TlsConstants.CipherSuite cipher;

    protected NewSessionTicket() {
    }

    public NewSessionTicket(TlsState state, NewSessionTicketMessage newSessionTicketMessage, de.tomcory.heimdall.scanner.traffic.connection.encryptionLayer.agent15.TlsConstants.CipherSuite currentCipher) {
