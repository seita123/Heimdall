...
import de.tomcory.heimdall.scanner.traffic.connection.encryptionLayer.agent15.handshake.TlsServerEngine;
import de.tomcory.heimdall.scanner.traffic.connection.encryptionLayer.agent15.handshake.TlsSessionRegistry;
import de.tomcory.heimdall.scanner.traffic.connection.encryptionLayer.agent15.handshake.TlsSessionRegistryImpl;
...
public class TlsServerEngineFactory {
    ...
    public de.tomcory.heimdall.scanner.traffic.connection.encryptionLayer.agent15.handshake.TlsServerEngine createServerEngine(ServerMessageSender serverMessageSender, TlsStatusEventHandler tlsStatusHandler) {
        de.tomcory.heimdall.scanner.traffic.connection.encryptionLayer.agent15.handshake.TlsServerEngine tlsServerEngine = new TlsServerEngine(serverCertificates, certificateKey, serverMessageSender, tlsStatusHandler, tlsSessionRegistry);
