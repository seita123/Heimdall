...
import de.tomcory.heimdall.scanner.traffic.connection.encryptionLayer.agent15.handshake.ClientMessageProcessor;
import de.tomcory.heimdall.scanner.traffic.connection.encryptionLayer.agent15.handshake.ClientMessageSender;
...
import static de.tomcory.heimdall.scanner.traffic.connection.encryptionLayer.agent15.TlsConstants.SignatureScheme.*;
...
public class TlsClientEngine extends TlsEngine implements ClientMessageProcessor {
    ...
    private de.tomcory.heimdall.scanner.traffic.connection.encryptionLayer.agent15.handshake.ClientHello clientHello;
    ...
    public void startHandshake(TlsConstants.NamedGroup ecCurve, List<TlsConstants.SignatureScheme> signatureSchemes) throws IOException {
        ...
        clientHello = new de.tomcory.heimdall.scanner.traffic.connection.encryptionLayer.agent15.handshake.ClientHello(serverName, publicKey, compatibilityMode, supportedCiphers, supportedSignatures,
    ...
    @Override
    public void received(de.tomcory.heimdall.scanner.traffic.connection.encryptionLayer.agent15.handshake.FinishedMessage finishedMessage, ProtectionKeysType protectedBy) throws ErrorAlert, IOException {
        if (protectedBy != ProtectionKeysType.Handshake) {
            throw new UnexpectedMessageAlert("incorrect protection level");
        }
        ...
        de.tomcory.heimdall.scanner.traffic.connection.encryptionLayer.agent15.handshake.FinishedMessage clientFinished = new FinishedMessage(clientHmac);
