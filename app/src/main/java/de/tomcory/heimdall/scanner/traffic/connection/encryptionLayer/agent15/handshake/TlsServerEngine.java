...
import de.tomcory.heimdall.scanner.traffic.connection.encryptionLayer.agent15.alert.*;
import de.tomcory.heimdall.scanner.traffic.connection.encryptionLayer.agent15.extension.*;
...
import de.tomcory.heimdall.scanner.traffic.connection.encryptionLayer.agent15.handshake.ClientHello;
import de.tomcory.heimdall.scanner.traffic.connection.encryptionLayer.agent15.handshake.EncryptedExtensions;
import de.tomcory.heimdall.scanner.traffic.connection.encryptionLayer.agent15.handshake.FinishedMessage;
...
import de.tomcory.heimdall.scanner.traffic.connection.encryptionLayer.agent15.handshake.ServerMessageProcessor;
import de.tomcory.heimdall.scanner.traffic.connection.encryptionLayer.agent15.handshake.ServerMessageSender;
import de.tomcory.heimdall.scanner.traffic.connection.encryptionLayer.agent15.handshake.TlsEngine;
import de.tomcory.heimdall.scanner.traffic.connection.encryptionLayer.agent15.handshake.TlsSession;
import de.tomcory.heimdall.scanner.traffic.connection.encryptionLayer.agent15.handshake.TlsSessionRegistry;
import de.tomcory.heimdall.scanner.traffic.connection.encryptionLayer.agent15.handshake.TlsStatusEventHandler;
...
import static de.tomcory.heimdall.scanner.traffic.connection.encryptionLayer.agent15.TlsConstants.CipherSuite.TLS_AES_128_GCM_SHA256;
import static de.tomcory.heimdall.scanner.traffic.connection.encryptionLayer.agent15.TlsConstants.NamedGroup.*;
import static de.tomcory.heimdall.scanner.traffic.connection.encryptionLayer.agent15.TlsConstants.PskKeyExchangeMode.psk_dhe_ke;
import static de.tomcory.heimdall.scanner.traffic.connection.encryptionLayer.agent15.TlsConstants.SignatureScheme.rsa_pss_rsae_sha256;
...
public class TlsServerEngine extends TlsEngine implements ServerMessageProcessor {
    ...
    @Override
    public void received(de.tomcory.heimdall.scanner.traffic.connection.encryptionLayer.agent15.handshake.ClientHello clientHello, ProtectionKeysType protectedBy) throws TlsProtocolException, IOException {
...
//        List<TlsConstants.NamedGroup> serverSupportedGroups = List.of(TlsConstants.NamedGroup.secp256r1, x25519);
       ...
       clientHello.getExtensions().stream()
        ...
        de.tomcory.heimdall.scanner.traffic.connection.encryptionLayer.agent15.handshake.ServerHello serverHello = new ServerHello(selectedCipher, extensions);
        ...
        de.tomcory.heimdall.scanner.traffic.connection.encryptionLayer.agent15.handshake.FinishedMessage finished = new de.tomcory.heimdall.scanner.traffic.connection.encryptionLayer.agent15.handshake.FinishedMessage(hmac);
