...
public class TranscriptHash {
     ...
     * @return
     */
    public byte[] getHash(de.tomcory.heimdall.scanner.traffic.connection.encryptionLayer.agent15.TlsConstants.HandshakeType msgType) {
     ...
     * @return
     */
    public byte[] getClientHash(de.tomcory.heimdall.scanner.traffic.connection.encryptionLayer.agent15.TlsConstants.HandshakeType msgType) {
     ...
     * @return
     */
    public byte[] getServerHash(de.tomcory.heimdall.scanner.traffic.connection.encryptionLayer.agent15.TlsConstants.HandshakeType msgType) {
    ...
    public void record(HandshakeMessage msg) {
        List<de.tomcory.heimdall.scanner.traffic.connection.encryptionLayer.agent15.TlsConstants.HandshakeType> ambigousTypes = List.of(de.tomcory.heimdall.scanner.traffic.connection.encryptionLayer.agent15.TlsConstants.HandshakeType.certificate,
                de.tomcory.heimdall.scanner.traffic.connection.encryptionLayer.agent15.TlsConstants.HandshakeType.certificate_verify, de.tomcory.heimdall.scanner.traffic.connection.encryptionLayer.agent15.TlsConstants.HandshakeType.finished);
   ...
   private void computeHash(ExtendedHandshakeType requestedType) {
    ...
    private ExtendedHandshakeType convert(de.tomcory.heimdall.scanner.traffic.connection.encryptionLayer.agent15.TlsConstants.HandshakeType type) {
        List<de.tomcory.heimdall.scanner.traffic.connection.encryptionLayer.agent15.TlsConstants.HandshakeType> ambigousTypes = List.of(de.tomcory.heimdall.scanner.traffic.connection.encryptionLayer.agent15.TlsConstants.HandshakeType.certificate,
                de.tomcory.heimdall.scanner.traffic.connection.encryptionLayer.agent15.TlsConstants.HandshakeType.certificate_verify, de.tomcory.heimdall.scanner.traffic.connection.encryptionLayer.agent15.TlsConstants.HandshakeType.finished);
    ...
    private ExtendedHandshakeType convert(de.tomcory.heimdall.scanner.traffic.connection.encryptionLayer.agent15.TlsConstants.HandshakeType type, boolean client) {
        if (type == de.tomcory.heimdall.scanner.traffic.connection.encryptionLayer.agent15.TlsConstants.HandshakeType.finished) {
            return client? ExtendedHandshakeType.client_finished: ExtendedHandshakeType.server_finished;
        }
        else if (type == de.tomcory.heimdall.scanner.traffic.connection.encryptionLayer.agent15.TlsConstants.HandshakeType.certificate) {
